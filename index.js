const template = `
  ...
  <div class='pixoodle-editor'>
  </div>
`;

let templateEl;

class PixoodleEditor extends HTMLElement {
  constructor() {
    super();
  ...
  connectedCallback() {
    ...
    const root = docFrag.querySelector('.pixoodle-editor');
...
customElements.define('pixoodle-editor', PixoodleEditor);
